...
import { Action, DB, ObjectType, defaultBlue,
  tableWidth,
  tableFieldHeight,
  tableHeaderHeight,
  tableColorStripHeight } from "../data/constants";
  ...
  const updateRelationship = (id, updatedValues) => {
   ...
   const autoArrangeTables = () => {
    ...
    relationships.forEach((rel) => {
      if (newGraph.hasNode(rel.startTableId) && newGraph.hasNode(rel.endTableId)) {
